public class Stack211g <T> {
    ...
    public Object[] myStack = new Object[40]; //new Object array for our use in this implementation
    ...
    public T pop() {//removes top element of @myStack, returns Object<T> to method
