select count(i.Project__Insight__Project__ID )as id from snp.Project_Information_20210930 i,snp.Project_Milestones_20210930 M
where i.Project__Insight__Project__ID =m.Project__Insight__Project__ID
and Project_Status in( 'Complete') 
and m.FM_Project__Milestones_Actual_Project_Complete between '7-1-2021' and '9-30-2021'
...
and(
	...
	--)
	and c.FM_Project__Milestones_Actual_Project_Complete between '7-1-2021' and '9-30-2021'
...
from snp.Project_Information_20210930 I
...
) select distinct ltrim(value) from c
